...
class MainWindow(QMainWindow):
    ...
    def rename_buttons(self):
        ...
        self.pushButton.setObjectName("btnStart")
        self.pushButton_2.setObjectName("btnStop")
        self.pushButton_3.setObjectName("btnQuit")
        self.pushButton_4.setObjectName("btnSupport")

        # Cambiar el texto mostrado en los botones
        self.pushButton.setText("Start")
        self.pushButton_2.setText("Stop")
        self.pushButton_3.setText("Quit")
        self.pushButton_4.setText("Support")
